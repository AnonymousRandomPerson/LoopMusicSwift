...
class DataMigrator: XCTestCase {
    ...
    /// To run, place the old database in the LoopMusicTests/Utils folder and rename it to "TracksOld.db". Add the file with target membership in LoopMusicTests. Then add "test" in front of this function's name and run it.

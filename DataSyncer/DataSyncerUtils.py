...
IOS_DATA_CONTAINER_PATH = '/Users/chenghanngan/Documents/Programs/iOS/LoopMusicSwift/Containers'
...
MACOS_DATA_DATA_PATH = '/Users/chenghanngan/Library/Containers/LoopMusic.LoopMusicSwift/Data'
# Absolute path to the documents directory in the macOS build.
MACOS_DATA_DOCUMENTS_PATH = MACOS_DATA_DATA_PATH + '/Documents'
...
def get_latest_ios_documents() -> str:
    ...
    containers.sort(key=lambda container : os.path.getmtime(IOS_DATA_CONTAINER_PATH + '/' + container))
    return IOS_DATA_CONTAINER_PATH + '/' + containers[-1] + '/' + IOS_DATA_DOCUMENTS_PATH